...
public class BasePage {
    ...
    public void waitForInvisibilityOfOverlay() {
        try {
            waitForInvisibilityOfElement(driver.findElement(By.xpath("//div[@id='Overlay']")));
        } catch (Exception e) {
            System.out.println("error occurred while waiting for invisibility of Overlay");
        }
    }
    ...
    public static String getScreenshot(String testMethodName, WebDriver driver) throws IOException {
        ...
        String imagePath = ".//screenshots//" + testMethodName + ".PNG";
